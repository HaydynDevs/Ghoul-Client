...
public class GuiQuitButton extends GuiButton {
    ...
    private static final TextureLocation tex_gui = new TextureLocation("/gui/GhoulClient/quit_game.png");

    public GuiQuitButton(int id, int x, int y, String text) {
        this(id, x, y, 200, 20, text);
    }

    public GuiQuitButton(int id, int x, int y, int width, int height, String text) {
