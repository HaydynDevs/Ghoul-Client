...
public class GuiAssetButton extends GuiButton {

    private static final TextureLocation tex_gui = new TextureLocation("/gui/GhoulClient/GuiAsset.png");

    public GuiAssetButton(int id, int x, int y, String text) {
        this(id, x, y, 200, 20, text);
    }

    public GuiAssetButton(int id, int x, int y, int width, int height, String text) {
